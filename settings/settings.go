...
func init() {
	open := func(path string) (internal.RegisterableMetadata, error) { return Open(path) }
...
func (c *Settings) SetMetadata(m internal.MetadataInfo) {
	c.MetadataInfo = m
}

func (c *Settings) Type() internal.MetadataType {
